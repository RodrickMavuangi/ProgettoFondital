...
namespace Fondital.Data.Migrations
{
    ...
    [Migration("20211102142058_DataFromExternalSvc")]
    partial class DataFromExternalSvc
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fondital.Shared.Models.AuditRapporto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Fondital.Shared.Models.Ricambio", b =>
                {
                    ...
                    b.Property<string>("ITDescription")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Fondital.Shared.Models.ServicePartner", b =>
                {
                    ...
                    b.Property<string>("StateRegistrationNr")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.OwnsOne("Fondital.Shared.Models.Caldaia", "Caldaia", b1 =>
                        {
                            ...
                            b1.OwnsOne("Fondital.Shared.Models.Brand", "Brand", b2 =>
                                {
                                    b2.Property<int>("CaldaiaRapportoId")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("int")
                                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                                    ...
                                    b2.HasKey("CaldaiaRapportoId");

                                    b2.ToTable("Rapporti");

                                    b2.WithOwner()
                                        .HasForeignKey("CaldaiaRapportoId");
                                });

                            b1.OwnsOne("Fondital.Shared.Models.Group", "Group", b2 =>
                                {
                                    b2.Property<int>("CaldaiaRapportoId")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Fondital.Shared.Models.Rapporto", b =>
                {
                    ...
                    b.Navigation("RapportiVociCosto");
