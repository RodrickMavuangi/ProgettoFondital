...
namespace Fondital.Server.Controllers
{
    ...
    public class MailController : ControllerBase
    {
        ...
        [HttpPost("NewUser")]
        public async Task<IActionResult> sendMailForNewUser(/*int servicePartnerId,*/ [FromBody] UtenteDto utenteDto)
        {
            ...
            try
            {
				...
				if (utente.ServicePartner != null)
				{
					...
					_servicePartner = await _spService.GetServicePartnerById(utente.ServicePartner.Id);
